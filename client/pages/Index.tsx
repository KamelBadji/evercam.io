import { ArrowRight, Camera, Plane, Maximize, CheckCircle2, Clock, Eye, Bell } from "lucide-react";
...
export default function Index() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative h-[944px] flex items-center justify-center overflow-hidden">
        {/* Background Image Placeholder */}
        <div className="absolute inset-0 bg-gradient-to-r from-slate-900/70 via-slate-900/60 to-slate-900/50 z-10" />
        <div className="absolute inset-0 bg-slate-700" />
        
        {/* Content */}
        <div className="relative z-20 mx-auto max-w-[768px] px-8 text-center">
          <p className="text-xl text-white/90 mb-4">
            Construction Reality Capture & Intelligence
          </p>
          <h1 className="text-7xl font-normal text-white leading-[90px] mb-8">
            Complete Visibility.<br />Built for Construction.
          </h1>
          <p className="text-2xl text-white/90 leading-[39px] mb-12">
          ...
          <div className="flex items-center justify-center gap-4">
            <Button 
              size="lg" 
              className="bg-[#C4161C] hover:bg-[#C4161C]/90 text-white h-14 px-4 text-lg font-medium rounded-md"
            >
              Book a Demo
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-[72px] left-1/2 -translate-x-1/2 w-6 h-10 rounded-full border-2 border-white/50 flex items-start justify-center pt-3">
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-[1216px] px-8 lg:px-14">
          ...
          <div className="text-center mb-16">
            <h2 className="text-5xl font-normal text-slate-900 mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex items-start gap-4 mb-6">
                <div className="w-1 h-24 bg-[#C4161C]" />
                <h2 className="text-5xl font-normal text-slate-900 leading-[48px]">
                  24/7 Automated Site Monitoring
                </h2>
              </div>

              <p className="text-xl text-slate-500 leading-[32.5px] mb-10">
                Never miss a moment with our professional-grade construction cameras. Capture every phase of your project automatically with time-lapse videos, live streaming, and comprehensive historical documentation.
              </p>
              ...
              <div className="flex items-center gap-4 mb-12">
                ...
                <Button variant="outline" className="border-[#C4161C] text-[#C4161C] hover:bg-[#C4161C]/10 text-sm font-medium">
                  See Pricing
                </Button>
              </div>

              {/* Stats */}
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-900/10">
            ...
            <div className="relative">
              <div className="w-full h-[500px] rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 shadow-2xl relative overflow-hidden">
              ...
              {/* Stats Card */}
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-2xl p-6 border border-slate-900/10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-2xl font-normal text-slate-900">10,000+</div>
                    <div className="text-sm text-slate-500">Cameras deployed</div>
                  </div>
                </div>
              </div>
            </div>
